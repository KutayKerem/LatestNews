...
import com.app.latestnews.databinding.FragmentSportsBinding
...
class SportsFragment : Fragment() {
    ...
    fun getNews(){
        ...
        val disposable = retrofit.getCategoryNews("us","sports", 100, BASE_APİ2)
    ...
    fun handleResponse(mainModel: mainModel){
        ...
        editor.putString("Sports",jsonStringNewsList)
        editor.apply()
    ...
    fun getJsonSharedPrefences(){
        ...
        val jsonString = editor.getString("Sports", null)

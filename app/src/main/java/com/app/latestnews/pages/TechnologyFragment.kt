...
import com.app.latestnews.databinding.FragmentTechnologyBinding
...
class TechnologyFragment : Fragment() {
    ...
    fun getNews(){
        ...
        val disposable = retrofit.getCategoryNews("us","technology", 100, BASE_APİ2)
    ...
    fun handleResponse(mainModel: mainModel){
        ...
        editor.putString("Technology",jsonStringNewsList)
        editor.apply()
    ...
    fun getJsonSharedPrefences(){
        ...
        val jsonString = editor.getString("Technology", null)

...
import com.app.latestnews.databinding.FragmentHealthBinding
...
class HealthFragment : Fragment() {
    ...
    fun getNews(){
        ...
        val disposable = retrofit.getCategoryNews("us","health", 100, BASE_APİ2)
    ...
    fun handleResponse(mainModel: mainModel){
        ...
        editor.putString("Health",jsonStringNewsList)
        editor.apply()
    ...
    fun getJsonSharedPrefences(){
        ...
        val jsonString = editor.getString("Health", null)

...
import com.app.latestnews.databinding.FragmentScienceBinding
...
class ScienceFragment : Fragment() {
    ...
    fun getNews(){
        ...
        val disposable = retrofit.getCategoryNews("us","science", 100, BASE_APİ2)
    ...
    fun handleResponse(mainModel: mainModel){
        ...
        editor.remove("Science")
        editor.putString("Science",jsonStringNewsList)
        editor.apply()
    ...
    fun getJsonSharedPrefences(){
        ...
        val jsonString = editor.getString("Science", null)

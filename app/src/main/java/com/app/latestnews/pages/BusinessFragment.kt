...
import com.app.latestnews.databinding.FragmentBusinessBinding
...
class BusinessFragment : Fragment() {
    ...
    fun getNews(){
        ...
        val disposable = retrofit.getCategoryNews("us","business", 100, BASE_APİ2)
    ...
    fun handleResponse(mainModel: mainModel){
        ...
        editor.putString("Business",jsonStringNewsList)
        editor.apply()
    ...
    fun getJsonSharedPrefences(){
        ...
        val jsonString = editor.getString("Business", null)
